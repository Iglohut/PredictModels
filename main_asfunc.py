...
# condition = subsets[0]
def classify(subsets=[None], n_sim=2000):
    """Input must be a list: None, 'con', 'or', 'od'"""
    for condition in subsets:
           ...
           for model in models:
                  ...
                  model.feature_importances(X_train, y_train, X_test, y_test, n_sim=n_sim, relative=True)
